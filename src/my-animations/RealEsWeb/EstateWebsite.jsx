          ...
          <div className="App">
            ...
            <section className="video-container">
              ...
              <div className="overlay-text">
                ...
                <p style={{fontSize: "10px", marginTop: "-5px"}}>Built with precision and care</p>
              </div>
            </section>

            <section className="about-nidhiland-page">
                <div style={{marginTop: "100px"}} className="page2-text-section">
                    <h1  data-aos="fade-up" style={{ margin: "10px", fontSize: "73px", textAlign: "left"}}>WE LOVE TO<br /> BUILD.</h1>
                    <div  data-aos="fade-up" style={{ margin: "10px", fontSize: "67px", textAlign: "left", width: "600px" }}>IT'S WHO WE ARE<br /> AND WHAT WE<br /> DO.</div>
                    <p style={{ margin: "10px", fontSize: "18px", textAlign: "left", width: "624.6px", marginTop: "30px", marginBottom: "30px"}}>Guided by founder Prashanth Sanil's values, Nidhiland focuses on quality, detail, and client satisfaction. Our team is committed to excellence, trust, and raising standards.</p>
                ...
                <div style={{marginTop: "60px", marginBottom: "60px"}} className="page2-image-section">
                    <div className="main-image">
                        <img style={{width: "145px", height: "260px", marginLeft: "200px"}} src={img1} alt="Main Project" />
                    </div>
                    <div className="small-images">
                        <img style={{ width: "145px", height: "122px", marginLeft: "200px" }} src={img2} alt="Project 2" />
                        <img style={{ width: "145px", height: "122px", marginLeft: "200px", marginTop: "15px" }}src={img3} alt="Project 3" />
                    </div>
                    <div className="main-image">
                        <img style={{width: "310px", height: "180px", marginLeft: "200px", marginTop: "0px"}} src={img4} alt="Project 4" />
                    </div>
                    <div className="main-image">
                        <img style={{ width: "145px", height: "260px", marginLeft: "365px" }} src={img5} alt="Main Project 5" />
                    </div>
                    <div className="small-images">
                        <img style={{ width: "145px", height: "122px", marginRight: "122px" }} src={img6} alt="Project 6" />
                        <img style={{ width: "145px", height: "122px", marginRight: "122px", marginTop: "15px" }} src={img7} alt="Project 7" />
                    </div>
                </div>
            </section>
            ...
            <section className="image-overlay-section">
                <div className="overlay-box">
                    <h1 style={{ fontSize: "40px", textAlign: "left", marginTop: "80px", marginLeft: "40px", marginBottom: "0px" }}>A Trusted,<br/> Collaborative<br/> Partner Focused<br/> on Your Goals</h1>
                    <p style={{ fontSize: "18px", textAlign: "left", width:"430px", marginLeft: "40px"}}>With a focus on excellence in craftsmanship, attention to detail, and client satisfaction, we deliver lasting value by aligning with what truly matters to you.</p>
            ...
            <div style={{marginTop: "60px", fontSize: "30px"}}>Elegance Around the Clock: Discover Our Vision in Daylight and After Dark</div>
            ...
            <div style={{paddingTop: "30px"}}className="testimonials-section">
